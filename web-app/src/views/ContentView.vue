  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 24px;">
      <div style="display: flex; align-items: center; gap: 16px; flex-wrap: wrap;">
        ...
        <div v-if="progress > 0">Архивация: {{ progress }}%</div>
    ...
    <div class="grid">
      <div class="card">
        ...
        <input
          v-model="contentSearch.cars"
          type="text"
          class="input"
          :placeholder="t.content.searchCars"
      ...
      <div class="card">
        ...
        <input
          v-model="contentSearch.tracks"
          type="text"
          class="input"
          :placeholder="t.content.searchTracks"
          style="margin-bottom: 16px;"
        />
...
const filteredCars = computed(() =>
  props.cars.filter((car) => car.id.toLowerCase().includes(props.contentSearch.cars.toLowerCase()))
)

const filteredTracks = computed(() =>
  props.tracks.filter((track) => track.id.toLowerCase().includes(props.contentSearch.tracks.toLowerCase()))
)
</script>
